<?php 
function industryup_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'industryup_page_menu_args' );
function industryup_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new Industryup_walker_page_menu;
...
class Industryup_walker_page_menu extends Walker_Page{
